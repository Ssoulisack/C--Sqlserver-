...
namespace WorkwithDB.MyDBDataSet1TableAdapters {
    ...
    public partial class namesTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[names] WHERE (([ID] = @Original_ID) AND ((@IsNull_Firstname = " +
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[names] SET [Firstname] = @Firstname, [Lastname] = @Lastname WHERE (([ID] = @Original_ID) AND ((@IsNull_Firstname = 1 AND [Firstname] IS NULL) OR ([Firstname] = @Original_Firstname)) AND ((@IsNull_Lastname = 1 AND [Lastname] IS NULL) OR ([Lastname] = @Original_Lastname)));
SELECT ID, Firstname, Lastname FROM names WHERE (ID = @ID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::WorkwithDB.Properties.Settings.Default.MyDBConnectionString;
        }
